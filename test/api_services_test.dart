  ...
  group('API Services Tests', () {
    ...
    group('AuthApiService Tests', () {
      ...
      test('Login with test credentials', () async {
        try {
          ...
          final testEmail =
              'testlogin${DateTime.now().millisecondsSinceEpoch}@example.com';
          final testUsername =
              'loginuser${DateTime.now().millisecondsSinceEpoch}';
    ...
    group('Authentication Flow Integration Test', () {
      test('Complete auth flow with backend', () async {
        final testEmail =
            'fullflow${DateTime.now().millisecondsSinceEpoch}@example.com';
